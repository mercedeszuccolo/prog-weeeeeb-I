const countries = [
  ...
  },
  {
    ...
    continent: "África",
    flag: "🇿🇦",
    language: "Inglés, Afrikáans, Zulu",
  },
  {
    name: "Suecia",
    abbreviation: "SE",
  ...
  },
  {
    ...
    continent: "Europa",
    flag: "🇧🇪",
    language: "Holandés, Francés, Alemán",
  },
  {
    name: "Hungría",
    abbreviation: "HU",
...
inputFiltro.addEventListener("input", function () {
  let texto = inputFiltro.value.trim().toLowerCase();

  let paisesFiltrados = [];

  countries.forEach(function (pais) {
    let nombre = pais.name.trim().toLowerCase();
